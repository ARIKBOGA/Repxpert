...
const filePathToRead = path.resolve(__dirname, '../data/katalogInfo/excels/marka_seri_no_tur.xlsx');
const filePathToWrite = path.resolve(__dirname, '../data/katalogInfo/jsons/marka_tur.json');
